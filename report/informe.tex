...
El sistema utiliza un mecanismo de bootstrap híbrido que combina el flag \texttt{--bootstrap} con lista de peers conocidos para arranque inicial, integración con DNS interno de Swarm para descobrir otros servicios, expansion dinámica donde una vez conectado el overlay gossip permite descubrir peers adicionales transitivamente, y resilience mediante tolerancia a fallos de nodos bootstrap a través de múltiples puntos de entrada.
